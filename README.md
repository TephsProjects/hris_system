...
ALTER TABLE employees
ADD philhealth_file VARCHAR(255) DEFAULT NULL,
ADD sss_file VARCHAR(255) DEFAULT NULL,
ADD pagibig_file VARCHAR(255) DEFAULT NULL,
ADD nbi_file VARCHAR(255) DEFAULT NULL;

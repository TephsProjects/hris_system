...
$result = $conn->query("SELECT * FROM branches ORDER BY branch_id DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- SIDEBAR (FULL COPY FROM DASHBOARD) -->
<div class="sidebar">
    <ul>
        ...
        <li class="dropdown active">
            ...
            <ul class="dropdown-content" style="display:block;">
                ...
                <li><a href="branch_list.php" class="active">Branch / Location List</a></li>
            </ul>
        </li>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_branch.php?id=<?= $row['branch_id']; ?>" class="btn btn-sm">Edit</a>
                    <a href="delete_branch.php?id=<?= $row['branch_id']; ?>" class="btn btn-sm" style="background:red;" onclick="return confirm('Delete this branch?')">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
